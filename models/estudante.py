...
class Estudante(db.Model):
    ...
    @classmethod
    def criar(cls, email: str, senha: str) -> "Estudante":
        ...
        estudante = cls(email=email, senha=senha)
    ...
    def autenticar(cls, email: str, senha: str):
        return cls.query.filter_by(email=email, senha=senha).first()
    ...
    lista_bloqueada = db.relationship(
        "ListaBloqueada",
        back_populates="estudante",
        cascade="all, delete-orphan",
    )
